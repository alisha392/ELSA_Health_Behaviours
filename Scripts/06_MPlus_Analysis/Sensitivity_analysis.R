...
# using function : rename(new_name = old_name)
...
save_kable(Indices,here("Figures","3787_cases","Fit_Indices_Sample_A.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ggtitle("Scree Plot of Sample A (1893 cases)") 
ggsave(here("Figures","3787_cases","Scree_Plot_Sample_A.pdf"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","Loglikelihood_Plot_Sample_A.pdf"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  ...
  "3" = paste0("Class 5 (", class_count[3, 3], ")"),
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('4','1','5','2','3'))
...
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('4','1','5','2','3'))
...
gg_split_1 <- data_split_1 %>%
  ...
  theme(
    ...
    legend.key.size = unit(1, "cm"), legend.text = element_text(size = 12), legend.title = element_text(size = 12, face="bold")
  )
gg_split_1
...
gg_no_legend <- Recoded_model_results %>%
  ...
  scale_fill_manual(values = colours_new, ) +
  facet_wrap(~LatentClass_factor, labeller = as_labeller(labels)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1), strip.text.x = element_text(size = 10), legend.position = "none",axis.title.x = element_text(vjust = -0.75))
gg_no_legend
...
final_plot
ggsave(here("Figures","3787_cases","LCA_5class_SampleA.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels =c('4','1','5','6','3','2'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels =c('4','1','5','6','3','2'))
...
ggsave(here("Figures","3787_cases","LCA_6class_SampleA.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  ...
  "5" = paste0("Class 3 (", class_count[5, 3], ")"),
  "6" = paste0("Class 6 (", class_count[6, 3], ")"),
  "7" = paste0("Class 5 (", class_count[7, 3], ")")
)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels=c('4','1','5','2','7','6','3'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels=c('4','1','5','2','7','6','3'))
...
gg_split_4 <- data_split_4 %>%
  ...
  facet_wrap(~LatentClass_factor, labeller = as_labeller(labels)) +
  theme(
    axis.text.x = element_text(angle = 90, hjust = 1,vjust=0.5), strip.text.x = element_text(size = 11),
    legend.key.size = unit(1, "cm"), legend.text = element_text(size = 12), legend.title = element_text(size = 12, face="bold")
  )
gg_split_4
...
ggsave(here("Figures","3787_cases","LCA_7class_SampleA.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
save_kable(Indices,here("Figures","3787_cases","Fit_Indices_Sample_B.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  theme(axis.text.x=element_text(size=14),axis.text.y=element_text(size=14),
        legend.title = element_text(size = 14, face="bold"),
        legend.text = element_text(size = 12))+
  ggtitle("Scree Plot of Sample B (1894 cases)") 
ggsave(here("Figures","3787_cases","Scree_Plot_Sample_B.pdf"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
Loglikelihood <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  theme(axis.text.x=element_text(size=14),axis.text.y=element_text(size=14),
        legend.title = element_text(size = 14, face="bold"),
        legend.text = element_text(size = 12))+
  ggtitle("Loglikelihood Plot of Sample B (1894 cases)") 
ggsave(here("Figures","3787_cases","Loglikelihood_Plot_Sample_B.pdf"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  "1" = paste0("Class 2 (", class_count[1, 3], ")"),
  "2" = paste0("Class 1 (", class_count[2, 3], ")"),
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('2','1','3','4','5'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('2','1','3','4','5'))
...
bar1 <- Recoded_model_results %>%
  ...
  labs(
    title = "Class-membership probabilities for LCA model",
    x = "Health behaviours across waves from baseline", y = "Item-class probabilities"
  ) +
  scale_fill_manual(values = colours_new) +
  facet_rep_wrap(~LatentClass_factor, labeller = as_labeller(labels), scales = "fixed", repeat.tick.labels = TRUE) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1), strip.text.x = element_text(size = 10))
...
gg_no_legend <- Recoded_model_results %>%
  ...
  labs(
    title = "Class-membership probabilities for LCA model (Sample B)",
    x = "Health behaviours across waves", y = "Item-class probabilities"
  ) +
  scale_fill_manual(values = colours_new, ) +
  facet_wrap(~LatentClass_factor, labeller = as_labeller(labels)) +
...
ggsave(here("Figures","3787_cases","LCA_5class_SampleB.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  "1" = paste0("Class 5 (", class_count[1, 3], ")"),
  "2" = paste0("Class 6 (", class_count[2, 3], ")"),
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('5','3','6','4','1','2'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('5','3','6','4','1','2'))
...
ggsave(here("Figures","3787_cases","LCA_6class_SampleB.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  "1" = paste0("Class 7 (", class_count[1, 3], ")"),
  "2" = paste0("Class 4 (", class_count[2, 3], ")"),
  "3" = paste0("Class 6 (", class_count[3, 3], ")"),
  "4" = paste0("Class 3 (", class_count[4, 3], ")"),
  "5" = paste0("Class 2 (", class_count[5, 3], ")"),
  "6" = paste0("Class 1 (", class_count[6, 3], ")"),
  "7" = paste0("Class 5 (", class_count[7, 3], ")")
)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels =c('6','5','4','2','7','3','1'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels =c('6','5','4','2','7','3','1'))
...
ggsave(here("Figures","3787_cases","LCA_7class_SampleB.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
save_kable(enum_summary,here("Figures","3787_cases","Fit_Indices_Complete_Sample.pdf"))
Indices <- enum_summary %>%
  kable(booktabs = T, linesep = "") %>%
  kable_styling(c("striped"),
                full_width = F,
...
ggsave(here("Figures","3787_cases","Scree_Plot_Complete_Sample.pdf"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
#### Plotting the log likelihood of models with different number of classes
...
ggsave(here("Figures","3787_cases","Loglikelihood_Plot_Complete_Sample.pdf"),Loglikelihood,width=30, height=22, dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('1','2','3','4','5','6'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('1','2','3','4','5','6'))
...
ggsave(here("Figures","3787_cases","LCA_5class_Complete_Sample.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  "1" = paste0("Low-risk (", class_count[1, 3], ")"),
  "2" = paste0("Low-risk yet heavy drinkers (", class_count[2, 3], ")"),
  "3" = paste0("Do nothing (", class_count[3, 3], ")"),
  "4" = paste0("Low-risk yet inactive (", class_count[4, 3], ")"),
  "5" = paste0("High-risk smokers (", class_count[5, 3], ")"),
  "6" = paste0("Inactive, heavy drinkers (", class_count[6, 3], ")"),
  "7" = paste0("Class 7 (", class_count[7, 3], ")")
)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('1','2','4','6','3','5'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass, levels = c('1','2','4','6','3','5'))
...
ggsave(here("Figures","3787_cases","LCA_6class_Complete_Sample.pdf"),final_plot,width=30, height=22, dpi=300,units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","LCA_7class_Complete_Sample.pdf"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
