...
#### This code is for cross validation of latent class model selection, only to be used to create 
# a subset of the final sample

main_data <- main_data[sample(nrow(main_data), nrow(main_data)/2), ]
...
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_3214cases", "Enumeration_Cross_Validation"))
getwd()
...
qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ggtitle("plot of cross-validation sample of 1607 cases") 
...
qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria") +
  ggtitle("Scree plot of cross-validation sample of 1607 cases") 


##### Step 1####
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_3214cases", "Selected_LCA_Model_Cross_Validation"))
getwd()
