...
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_5429cases", "Enumeration"))
getwd()
...
qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ggtitle("Scree Plot of 5429 cases") 
...
##### Step 1####
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_5429cases", "Selected_LCA_Model"))
getwd()
