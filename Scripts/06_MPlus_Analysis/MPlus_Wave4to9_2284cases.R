...
IDs_3214cases <- read_csv(here("Data", "Processed_Data", "R_Data", "Included_IDs", "Merged_4to9_IDs_withWave9nutrition.csv"))
...
#### This code is for randomly splitting the data into two halves for
# cross validation of latent class model selection, only to be used to create 
# a subset of the final sample

##### VERY VERY IMPORTANT !!! #####
###Choose this if you want to test the data subsets : Sample A and Sample B that have
# already been created
Sample_A <- read_csv(here("Data","Processed_Data","MPlus_data","MPlus_2284cases","Split_sample","Sample_A.csv"))

Sample_A <- Sample_A %>% 
  dplyr::select(-1)


Sample_B <- read_csv(here("Data","Processed_Data","MPlus_data","MPlus_2284cases","Split_sample","Sample_B.csv"))
Sample_B <- Sample_B %>% 
  dplyr::select(-1)
###Choose this if you want to create the data subsets : Sample A and Sample B 
...
write.csv(Sample_A, here("Data","Processed_Data","MPlus_data","MPlus_2284cases","Split_sample","Sample_A.csv"))
write.csv(Sample_B, here("Data","Processed_Data","MPlus_data","MPlus_2284cases","Split_sample","Sample_B.csv"))



#### SAMPLE A : Class enumeration #####
#setting to relative path as MPlus only accepts 90 characters in each line 
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_2284cases","Split_sample", "Class_enumeration_SampleA"))
getwd()
...
save_kable(Indices,here("Figures","2284_cases","Fit_Indices_Sample_A.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ggtitle("Scree Plot of Sample A (1142 cases)") 

ggsave(here("Figures","2284_cases","Scree_Plot_Sample_A.png"),Screeplot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
Loglikelihood <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria") +
  ggtitle("Loglikelihood Plot of Sample A (1142 cases)") 

ggsave(here("Figures","2284_cases","Loglikelihood_Plot_Sample_A.png"),Loglikelihood,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
final_plot
ggsave(here("Figures","2284_cases","LCA_5class_SampleA.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_6class_SampleA.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_7class_SampleA.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
#setting to relative path as MPlus only accepts 90 characters in each line 
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_2284cases","Split_sample", "Class_enumeration_SampleB"))
getwd()
lca_k1_6 <- lapply(1:9, function(k) {
  lca_enum <- mplusObject(
    TITLE = glue("C{k}_LCA_enumerate"),
...
save_kable(Indices,here("Figures","2284_cases","Fit_Indices_Sample_B.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria")+
  ggtitle("Scree Plot of Sample B (1142 cases)") 
ggsave(here("Figures","2284_cases","Scree_Plot_Sample_B.png"),Screeplot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
Loglikelihood <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria") +
  ggtitle("Loglikelihood Plot of Sample B (1142 cases)") 
ggsave(here("Figures","2284_cases","Loglikelihood_Plot_Sample_B.png"),Loglikelihood,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_5class_SampleB.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_6class_SampleB.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_7class_SampleB.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
#setting to relative path as MPlus only accepts 90 characters in each line 
setwd(here("Data", "Processed_Data", "MPlus_data","MPlus_2284cases","Complete_sample"))
getwd()
lca_k1_6 <- lapply(1:9, function(k) {
  lca_enum <- mplusObject(
    TITLE = glue("C{k}_LCA_enumerate"),
...
save_kable(Indices,here("Figures","2284_cases","Fit_Indices_Complete_Sample.png"))
...
Screeplot <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria")+
  ggtitle("Scree Plot of complete sample (2284 cases)") 
ggsave(here("Figures","2284_cases","Scree_Plot_Complete_Sample.png"),Screeplot,width=30, height=22, units=c("cm"),limitsize = FALSE)
#### Plotting the log likelihood of models with different number of classes
...
Loglikelihood <- qplot(Title, values, data = results2, color = factor(criterias))+
  ...
  ylab("Values") +
  scale_color_discrete("Information criteria") +
  ggtitle("Loglikelihood Plot of complete sample (2284 cases)") 
ggsave(here("Figures","2284_cases","Loglikelihood_Plot_Complete_Sample.png"),Loglikelihood,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_5class_Complete_Sample.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_6class_Complete_Sample.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","2284_cases","LCA_7class_Complete_Sample.png"),final_plot,width=30, height=22, units=c("cm"),limitsize = FALSE)
