...
t7 <- tidy(prop.test(x = c(sum(Complete_case$Education_Upper_Second), sum(Missing_case$Education_Upper_Second,na.rm = TRUE)), n = c(nrow(Complete_case),length(na.omit(Missing_case$Education_Upper_Second))
),alternative = "two.sided"))
t8 <- tidy(prop.test(x = c(sum(Complete_case$Education_Tertiary), sum(Missing_case$Education_Tertiary,na.rm = TRUE)), n = c(nrow(Complete_case),length(na.omit(Missing_case$Education_Tertiary))
),alternative = "two.sided"))
