...
###Choose this if you want to select the data subsets : Sample A and Sample B that have
...
Sample_B <- Sample_B %>% 
  dplyr::select(-1)
###Choose this  if you want to change and create new data subsets : Sample A and Sample B 
# and randomly split the orginial data in r
...
ggsave(here("Figures","3787_cases","Scree_Plot_Sample_A.png"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","Loglikelihood_Plot_Sample_A.png"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('4','1','2','5','3'))
...
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('4','1','2','5','3'))
...
final_plot
ggsave(here("Figures","3787_cases","LCA_5class_SampleA.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('4','1','5','3','6','2'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('4','1','5','3','6','2'))
...
ggsave(here("Figures","3787_cases","LCA_6class_SampleA.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  ...
  "3" = paste0("Class 5 (", class_count[3, 3], ")"),
  "4" = paste0("Class 1 (", class_count[4, 3], ")"),
  "5" = paste0("Class 7 (", class_count[5, 3], ")"),
  "6" = paste0("Class 6 (", class_count[6, 3], ")"),
  "7" = paste0("Class 3 (", class_count[7, 3], ")")
)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('2','4','5','1','7','6','3'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('2','4','5','1','7','6','3'))
...
ggsave(here("Figures","3787_cases","LCA_7class_SampleA.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","Scree_Plot_Sample_B.png"),Screeplot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","Loglikelihood_Plot_Sample_B.png"),Loglikelihood,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('2','1','4','3','5'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('2','1','4','3','5'))
...
bar1 <- Recoded_model_results %>%
  ...
  labs(
    title = "Class-membership probabilities for LCA model",
    x = "Years of follow up from baseline from baseline", y = "Item-class probabilities"
  ) +
  scale_fill_manual(values = colours_new) +
  facet_rep_wrap(~LatentClass_factor, labeller = as_labeller(labels), scales = "fixed", repeat.tick.labels = TRUE) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1), strip.text.x = element_text(size = 10))
...
ggsave(here("Figures","3787_cases","LCA_5class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
ggsave(here("Figures","3787_cases","LCA_6class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
labels <- c(
  ...
  "7" = paste0("Class 1 (", class_count[7, 3], ")")
)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('2','6','4','5','7','3','1'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('2','6','4','5','7','3','1'))
...
ggsave(here("Figures","3787_cases","LCA_7class_SampleB.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('1','2','4','3','5'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels=c('1','2','4','3','5'))
...
ggsave(here("Figures","3787_cases","LCA_5class_Complete_Sample.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
...
model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('4','1','3','2','5','6','7'))
...
Recoded_model_results$new_category <- as.factor(Recoded_model_results$new_category)
Recoded_model_results$LatentClass_factor <- factor(model_results$LatentClass,levels= c('4','1','3','2','5','6','7'))
...
ggsave(here("Figures","3787_cases","LCA_7class_Complete_Sample.png"),final_plot,width=30, height=22,dpi=300, units=c("cm"),limitsize = FALSE)
